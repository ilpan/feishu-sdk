...
class BaseClient:
    ...
    def __init__(self, base_url: str = BASE_URL, app_id: str = None, app_secret: str = None):
    ...
    async def tenant_access_token_internal(self) -> str:
        ...
        resp = await self.api_call("/auth/v3/tenant_access_token/internal/", params=params)
    ...
    async def api_call(self,
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            try:
                resp_json = await self.fetch(session, self.__build_url(api), params=params, json=json)
    ...
    @staticmethod
    async def fetch(session: ClientSession, url: str, params: dict = None, json: dict = None):
